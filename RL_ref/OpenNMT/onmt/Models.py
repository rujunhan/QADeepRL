...
class StdRNNDecoder(RNNDecoderBase):
    ...
    def _run_forward_pass(self, tgt, memory_bank, state, memory_lengths=None):
        ...
        p_attn.requires_grad = True
        #print("p_attn")
        #print(p_attn.requires_grad)
        attns["std"] = p_attn
...
class InputFeedRNNDecoder(RNNDecoderBase):
    ...
    def _run_forward_pass(self, tgt, memory_bank, state, memory_lengths=None):
        ...
        for i, emb_t in enumerate(emb.split(1)):
            ...
            #print("rnn_output")
            #print(rnn_output.requires_grad)
            #rnn_output.requires_grad = True
            ...
            #decoder_output.requires_grad = True
            #print(decoder_output.requires_grad)
        ...
        #print("Run")
        #print(decoder_outputs[0].requires_grad)
        # Return result.
...
class RNNDecoderState(DecoderState):
    def __init__(self, hidden_size, rnnstate):
        ...
        # have to set requires_grad to True for backprop
    ...
    def repeat_beam_size_times(self, beam_size):
        ...
        ### RJ: why set volatile to True ??? screw up computation graph
